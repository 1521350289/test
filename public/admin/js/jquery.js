...
//在另一个地方没有防护，仅为此模块定义全局似乎更安全
	...
	isPlainObject：function（obj）{
            ...
            //带有原型的对象如果它们是由全局Object函数构造的则是普通的
...
//优化push.apply（_，NodeList）
    ...
    *删除最旧的条目
        ...
        * /
        ...
        / **
        *返回在pseudos中使用的函数：enabled /：disabled
        ...
        function createDisabledPseudo（disabled）{
            ...
            return函数（elem）{
                ...
                if（elem中的“form”）{
                    ...
                    //有些受害者被我们的网（标签，图例，菜单，曲目）抓住了，但不应该
